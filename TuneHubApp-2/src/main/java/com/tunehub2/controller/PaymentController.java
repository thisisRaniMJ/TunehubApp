...
import com.tunehub2.services.UsersService;
...
public class PaymentController {
	...
	public String createOrder() {
		Order order = null;
		try {
			RazorpayClient razorpay = new RazorpayClient("rzp_test_6DimR09JYLS62z", 
					"t5yU4Q5PLv1BI3rFb0nAROiL");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
			...
			RazorpayClient razorpayClient = new RazorpayClient("rzp_test_6DimR09JYLS62z", 
	        								"t5yU4Q5PLv1BI3rFb0nAROiL");
